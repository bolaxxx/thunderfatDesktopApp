...
import control.ControlListPacienteWindow;
 ...
 * @author sergio
 */
public class ListPacienteWindow extends JInternalFrame{
    
    private static ListPacienteWindow listPacienteWindow;
	private ControlListPacienteWindow control;
...
//	public JComboBox<String> userTypeComboBox;
	...
	public JButton addUser;
        ...
        private ListPacienteWindow(ControlListPacienteWindow c, MyTableModel m){
		super("Lista Paciente",true,true,true,true);
		this.control = c;				
...
//		this.userPanel.add(userTypeComboBox,BorderLayout.EAST);
	...
	public static ListPacienteWindow getInstance(ControlListPacienteWindow c, MyTableModel m){
		if (listPacienteWindow == null){
			listPacienteWindow = new ListPacienteWindow(c,m);
		}
		
		if (listPacienteWindow.isVisible()) {
			try {
				listPacienteWindow.setSelected(true);
			} catch (PropertyVetoException e) {
				e.printStackTrace();
			}
		} else {
			listPacienteWindow.setVisible(true);
		}	
